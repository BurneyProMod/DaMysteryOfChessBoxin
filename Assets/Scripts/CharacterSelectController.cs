...
public class CharacterSelectController : MonoBehaviour
{
    ...
    public Text teamone;
    public Text teamtwo;
    private ArrayList teamonearray;
    private ArrayList teamtwoarray;
    // Use this for initialization
    void Start()
    {
        teamonearray = new ArrayList();
        teamtwoarray = new ArrayList();
            ...
            if (Input.GetButtonDown("A1"))
            {
                if (P1teamIndex < 4)
                {
                    ...
                    if (!inTeam)
                    {
                        ...
                        teamonearray.Add(GameManager.fighters[P1teamIndex].fighterName);
                        teamone.text += "\n" + GameManager.fighters[P1teamIndex].fighterName;
                        P1teamIndex++;
            ...
            if (Input.GetButtonDown("A2"))
            {
                ...
                if (P2teamIndex < 8)
                {
                    ...
                    if (!inTeam)
                    {
                        ...
                        teamtwoarray.Add(GameManager.fighters[P2teamIndex].fighterName);
                        teamtwo.text += "\n" + GameManager.fighters[P2teamIndex].fighterName;
                        P2teamIndex++;
                        Debug.Log(teamtwo.text.Length);
                    }
                    else
                    {
                        //play negative sound
